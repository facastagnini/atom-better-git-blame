...
class GutterItem extends React.Component {
    ...
    tooltip() {
        ...
        return (<div className="layer-tooltip">
        ...
        <SearchInLayer onClick={this.clickLayerSearch.bind(this)} onMouseEnter={this.mouseEnterLayerSearch.bind(this)} onMouseLeave={this.mouseLeaveLayerSearch.bind(this)}/>
      </div>);
    }
    formattedText() {
    ...
    render() {
        ...
        return (<TooltipContainer tooltipContent={this.tooltip.bind(this)}>
        {this.formattedText()}
      </TooltipContainer>);
    }
}
