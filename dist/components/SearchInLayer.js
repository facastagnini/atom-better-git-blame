...
class SearchInLayer extends React.PureComponent {
    render() {
        if (ConfigManager.get('searchInLayerEnabled')) {
          ...
          <div className="section-content">
            ...
            <p className="section-body">
              ...
              <span className="layer-button btn btn-default icon icon-link-external" onClick={this.props.onClick} onMouseEnter={this.props.onMouseEnter} onMouseLeave={this.props.onMouseLeave}>
                Open
              </span>
            </p>
          </div>
        ...
        return (<div className="section powered-by">
        <div className="section-content">
          <p className="section-body">
            Powered by&nbsp;
